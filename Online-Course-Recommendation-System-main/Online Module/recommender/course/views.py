...
def chapter(request, pk, cpk):
 ...
 # Ensure CourseChapter is imported

# def chapter(request, pk, cpk):
#     course_obj = get_object_or_404(Course, pk=pk)  # Get course object safely
#     chapter_obj = get_object_or_404(Chapter, pk=cpk)  # Get chapter object safely
